...
import { CommonActions, NavigationContainer , useRoute} from '@react-navigation/native';
...
function MyStack() {
  ...
  function MyDrawer({ route, navigation }) {
    ...
    <Drawer.Screen name="MyHeader" component={MyHeader} options={{headerShown: false}}/>
   ...
   <Stack.Screen name="InProgressListOrders" component={InProgressListOrders} options={{headerShown: false}}/>
   <Stack.Screen name="CompletedOrdersList" component={CompletedOrdersList} options={{
     headerShown: true,
   ...
   <Stack.Screen name="PendingOrdersList" component={PendingOrdersList} 
   options={{
     headerShown: true,
...
<Stack.Screen name="PaymentTopTapNavigator" component={ PaymentTopTapNavigator } options={{
     headerShown: true,
     title:"Purchased Payment",
     headerTitleStyle:{
       color:"white",
       alignSelf:'center'
     },
   ...
   <Stack.Screen name="MyHeader" component={MyHeader} options={{headerShown: false}}/>
   <Stack.Screen name="PurchasedOrdersList" component={PurchasedOrdersList} options={{
     headerShown: true,
   ...
   <Stack.Screen name="DeliveryNote" component={DeliveryNote} options={{
     headerShown: true,
     title:"DELIVERY NOTE",
     headerTitleStyle:{
       color:"white",
   ...
   <Stack.Screen name="PurchasedOrderStatus" component={PurchasedOrderStatus} options={{
     headerShown: true,
     title:"ORDERS STATUS",
     headerTitleStyle:{
       color:"white",
...
<Stack.Screen
        ...
        />
   <Stack.Screen name="ShowInvoice" component={ShowInvoice} options={{
     headerShown: true,
     title:"INVOICE",
     headerTitleStyle:{
       color:"white",
