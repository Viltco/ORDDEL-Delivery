...
import { Container, Header, Content, Input, Item , Form , Label , Button , Text,Spinner,Picker } from 'native-base';
import { StyleSheet , View , ImageBackground,KeyboardAvoidingView,ScrollView, TextInput,TouchableOpacity ,Platform, Image,ActivityIndicator,FlatList} from 'react-native';
  ...
  const onSubmit=()=>{
    ...
    return (
        ...
        <Spinner color={Colors.themeColor} />
          ...
          <View style={{paddingTop:Platform.OS=="android"?"30%":"20%"}}>
          <TextInput
                style={styles.n_inputArea}
                // underlineColorAndroid="rgba(0, 0, 0, 0)"
                // autoFocus={true}
                placeholder={bankDetail==""?"Bank Name":bankDetail[0]["bank_name"]}
              ...
              <TextInput
                ...
                // underlineColorAndroid="rgba(0, 0, 0, 0)"
                // autoFocus={true}
                placeholder={bankDetail==""?"Account Title":bankDetail[0]["account_title"]}
                autoCapitalize="words"
                placeholderTextColor={Colors.productGrey}
                // keyboardType="email-address"
                value={accountTitle}
              ...
              <TextInput
                ...
                // underlineColorAndroid="rgba(0, 0, 0, 0)"
                // autoFocus={true}
                placeholder={bankDetail==""?"Account Number":bankDetail[0]["credit_card_no"]}
                // autoCapitalize="words"
                placeholderTextColor={Colors.productGrey}
              ...
              <TextInput
                ...
                // underlineColorAndroid="rgba(0, 0, 0, 0)"
                // autoFocus={true}
                placeholder={bankDetail==""?"Sort Code":bankDetail[0]["sort_code"]}
                autoCapitalize="none"
                placeholderTextColor={Colors.productGrey}
                // keyboardType="email-address"
                keyboardType="numeric"
...
{loading ? (
                      <Spinner color={"white"} />
                    ) : (bankDetail==""?<Text style={styles.c_signupButtonText}>SUBMIT</Text>:<Text style={styles.c_signupButtonText}>UPDATE</Text>
          )}
        </TouchableOpacity>
          </View>
