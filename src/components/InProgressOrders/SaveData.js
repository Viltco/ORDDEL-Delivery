...
const SaveData = ({ navigation, route }) => {
  ...
  const updatedList=useSelector(state=>state.Consolidate.items);
  //const jogar1=useSelector(state=>state.Consolidate.items);
  console.log(updatedList,'1234......')
        ...
        style = {{marginTop:5,marginBottom:5 
            ...
            onPress={()=>{
                ...
                // alert(jogar[item.date]);
                 let obj = cartItems.find(o => o.date === checkDate);
                  let idj = cartItems.find(o => o.product_id == item.product_id);
                // alert(obj)
                console.log("@@@@@.....                          ",obj);
                console.log("@@@@@..... idj                         ",idj);
                // alert(obj.date);
                ...
                if(obj!=undefined){
                  if (idj!=undefined?idj.product_id==item.product_id:null&&obj.date==checkDate ) {
      ...
      >
        <View style={styles.centeredView}>
          ...
          <View style={styles.radioButtonContainer}>   
                ...
                />
                <Text style={{ paddingTop:10, fontSize:12, marginRight:5 }}>Profit Per Unit</Text> 
                {/* <Text> {cash} </Text> */}
        </View>
